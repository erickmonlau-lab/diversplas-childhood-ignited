...
async function generateOgImage() {
  const inputFile = path.join(brainDir, 'media__1781597009066.jpg'); // The new square illustration
  ...
  await sharp(inputFile)
    ...
    .jpeg({ quality: 90 })
    .toFile(path.join(publicDir, 'og-diversplas-v2.jpg'));

  console.log('og-diversplas-v2.jpg generated!');
}
