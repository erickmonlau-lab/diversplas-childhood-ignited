    ...
    <footer className="w-full bg-white border-t-2 border-black text-black">
      ...
      <div className="bg-white py-6 px-6">
        <div className="mx-auto max-w-[1400px] flex flex-wrap justify-between items-center gap-6">
          ...
          {/* Zona Derecha: Mascota pícara más grande + Redes y Créditos */}
          <div className="flex items-center gap-5 flex-wrap">
            {/* Personaje con el spray escondido y ojo pícaro con tamaño generoso y bocadillo */}
            <div className="relative group flex items-center pr-2">
              {/* Bocadillo de diálogo siempre visible y llamativo */}
              <div className="absolute -top-10 -left-6 bg-white text-black font-black text-xs px-3 py-1.5 rounded-2xl border-2 border-black shadow-[3px_3px_0_0_#000] whitespace-nowrap z-20 pointer-events-none group-hover:scale-105 transition-transform">
                ¿Yo? ¡Si soy un santo! 😇🎨
                <div className="absolute -bottom-1.5 right-6 w-2.5 h-2.5 bg-white border-r-2 border-b-2 border-black rotate-45" />
              </div>

              <img
                src="/mascot-hiding.webp"
                alt="Mascota Diversplas Ojo Pícaro"
                className="h-24 sm:h-28 w-auto object-contain drop-shadow-[0_8px_16px_rgba(0,0,0,0.3)] hover:scale-105 transition-transform duration-300 relative z-10"
                loading="lazy"
                width={105}
                height={140}
              />
