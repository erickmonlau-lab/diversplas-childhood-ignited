    ...
    <footer className="w-full bg-white border-t-2 border-black text-black">
      ...
      <div className="bg-white pt-16 pb-8 px-6 relative z-30 overflow-visible">
        <div className="mx-auto max-w-[1400px] flex flex-wrap justify-between items-center gap-6 overflow-visible">
          {/* Zona Izquierda: Marca y Enlaces Neo-Brutalistas */}
          <div className="flex items-center gap-5 flex-wrap">
            <a href="#top" className="flex items-center group transition-transform hover:scale-105 duration-200">
              <img
                src="/diversplas-logo-graffiti.webp"
                alt="DIVERSPLAS"
                className="h-16 sm:h-20 w-auto object-contain drop-shadow-[2px_2px_0_rgba(0,0,0,0.1)]"
                loading="lazy"
                decoding="async"
                width={110}
                height={80}
            ...
            <div className="flex flex-wrap items-center gap-2.5">
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-white text-black font-black text-xs px-3.5 py-1.5 rounded-full border-2 border-black shadow-[2.5px_2.5px_0_0_#000] hover:bg-[#D8E600] hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all uppercase tracking-wider"
              >
                <span className="w-2 h-2 rounded-full bg-[#1D2F8C]" />
                diversplas.es
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 bg-white text-black font-black text-xs px-3.5 py-1.5 rounded-full border-2 border-black shadow-[2.5px_2.5px_0_0_#000] hover:bg-[#FF6B6B] hover:text-white hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all uppercase tracking-wider"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-1.5 bg-[#1D2F8C] text-white font-black text-xs px-3.5 py-1.5 rounded-full border-2 border-black shadow-[2.5px_2.5px_0_0_#000] hover:bg-[#35D0BA] hover:text-black hover:translate-x-[-1px] hover:translate-y-[-1px] transition-all uppercase tracking-wider"
              >
                <span>💼</span>
