          ...
          <div className="lg:col-span-5">
            ...
            <div className="space-y-6">
              <a
                ...
                className="inline-flex items-center justify-center gap-3 rounded-full bg-[#25D366] text-black px-7 py-4 font-extrabold border-2 border-black shadow-[4px_4px_0_0_#000] hover:bg-[#20bd5a] hover:scale-[1.02] transition-all uppercase text-center w-full sm:w-auto"
                style={{ ...btnStyle, fontSize: "0.95rem" }}
              >
                ...
                <span className="whitespace-nowrap">WHATSAPP COORDINACIÓN: 657 117 426</span>
              </a>

              {/* Muñeco Mascota en Grande */}
              <div className="pt-2">
                <img
                  src="/mascot-boy.webp"
                  alt="Mascota Diversplas"
                  className="w-40 sm:w-48 md:w-56 h-auto drop-shadow-[0_10px_20px_rgba(0,0,0,0.4)] animate-[float_4.5s_ease-in-out_infinite]"
                  width={224}
                  height={330}
                  loading="lazy"
                />
