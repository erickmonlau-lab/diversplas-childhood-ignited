  ...
  return (
    <div className="relative w-full h-full min-h-[260px] max-w-[360px] select-none flex items-center justify-center">
      ...
      <div className="relative w-[340px] h-[250px] flex items-end justify-center">
        ...
        {/* ─── CHIP B2B INFERIOR IZQUIERDA: COLEGIOS (Separado hacia afuera y más abajo de las piernas) ─── */}
        ...
        {/* ─── CHIP B2B INFERIOR DERECHA: CASALES (Separado hacia afuera de la zapatilla derecha) ─── */}
        ...
        {/* La boquilla del bote está en torno a left: 88px, top: 124px */}
        <svg
          viewBox="0 0 120 120"
        ...
        {/* ─── EL PERSONAJE DIVERSPLAS (EN POSE DE SALUDO) ─── */}
