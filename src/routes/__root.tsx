...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.diversplas.es" },
      { property: "og:image", content: "https://www.diversplas.es/og-diversplas-v3.jpg" },
      ...
      { name: "twitter:image", content: "https://www.diversplas.es/og-diversplas-v3.jpg" },
    ],
    links: [
      {
        rel: "stylesheet",
      ...
      { rel: "canonical", href: "https://www.diversplas.es" },
      { rel: "icon", type: "image/png", sizes: "48x48", href: "https://www.diversplas.es/favicon-48.png" },
      { rel: "icon", type: "image/png", sizes: "192x192", href: "https://www.diversplas.es/favicon-192.png" },
      { rel: "apple-touch-icon", href: "https://www.diversplas.es/apple-touch-icon.png" },
    ],
  }),
