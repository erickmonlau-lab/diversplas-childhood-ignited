...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Experiencias extraescolares premium para colegios, A.F.As y centros educativos." },
      ...
      { property: "og:description", content: "Más de 20 años creando experiencias extraescolares en Barcelona. Para colegios, A.F.As y familias." },
    ...
    links: [
      ...
      { rel: "icon", type: "image/png", sizes: "192x192", href: "/favicon-192.png?v=7" },
      { rel: "apple-touch-icon", href: "/apple-touch-icon.png?v=7" },
    ],
  }),
