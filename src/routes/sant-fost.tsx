...
export const Route = createFileRoute('/sant-fost')({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Empresa especializada en actividades extraescolares y casales en Sant Fost de Campsentelles para colegios y AFAs. Activitats extraescolars a Sant Fost de Campsentelles." },
